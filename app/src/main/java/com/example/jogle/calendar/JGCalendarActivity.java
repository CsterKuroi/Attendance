...
import com.example.jogle.calendar.doim.CalendarViewBuilder;
import com.example.jogle.calendar.doim.CustomDate;
import com.example.jogle.calendar.widget.CalendarView;
import com.example.jogle.calendar.widget.CalendarViewPagerLisenter;
import com.example.jogle.calendar.widget.CustomViewPagerAdapter;
...
//	private TextView showWeekView;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		CalendarView.list = operation.getByUID(String.valueOf(uid));
...
//	 showWeekView.setText(DateUtil.weekName[DateUtil.getWeekDay()-1]);
	...
	public void clickDate(CustomDate date) {
		...
		for (int i = 0; i < CalendarView.list.size(); i++) {
			JGDataSet item = CalendarView.list.get(i);
...
//	}
	...
	private void getData() {
		...
		for (int i = 0; i < uids.size(); i++) {
			Map<String, Object> map = new HashMap<String, Object>();
			map.put("name", String.valueOf(uids.get(i).intValue()));
			map.put("department", "");
