    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(entry.this, JGMainActivity.class);
                try {
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(entry.this, JGMain2Activity.class);
                try {
                    intent.putExtra("uid", Integer.parseInt(et2.getText().toString()));
                    intent.putExtra("name", et3.getText().toString());
                    startActivity(intent);
        ...
        b3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(entry.this, JGCalendarActivity.class);
                try {
                    intent.putExtra("uid", Integer.parseInt(et2.getText().toString()));
                    intent.putExtra("name", et3.getText().toString());
                    startActivity(intent);
